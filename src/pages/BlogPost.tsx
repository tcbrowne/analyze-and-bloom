  ...
  const blogPosts = [
    {
      ...
      fullContent: `
        <div class="prose prose-lg max-w-none">
          ...
          <div class="my-8">
            <img src="https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800&h=400&fit=crop&auto=format&q=75" alt="Highway with trucks transportation" class="w-full h-64 object-cover rounded-lg shadow-lg" loading="lazy" />
